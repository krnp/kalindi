 ...
 <div class="row hidemsg" >
  ...
  <div class="x_panel">
    ...
    <div class="x_content"> <br>
      <form class="form-horizontal" method="POST" action="<?php echo e(url('journal/edit')); ?>/<?php echo e($result->id); ?>" enctype="multipart/form-data">
...
<div style="padding: 3% 0;">
     ...
     <div class="row">
          ...
          <input type="text" name="v_no" value="<?php echo e($result->v_no); ?>" onkeyup="this.value=this.value.replace(/[^\d]/,'')"  class="form-control" maxlength="6" required>
            ...
            <div class="col-md-6">
              <div class="row">
                ...
                <div class="col-md-12">
                  <input type="text" name="case_no" value="<?php echo e($result->case_no); ?>" class="form-control" maxlength="10" required="">
                </div>
              </div>
            </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-12">
                <label class="control-label"> NARR <span class="required">*</span></label>
              </div>
              <div class="col-md-12">
       ...
       <div class="row">
          <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <input type="text" name="folio_no" value="<?php echo e($result->folio_no); ?>" class="form-control" required>
              </div>
            </div>
          </div>
        </div>
         <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <input type="text" name="amount" value="<?php echo e($result->amount); ?>" id="chosen-keyword-container" class="form-control num1 key"  required>
              </div>
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-12">
                <input name="date" id="date" value="<?php echo e($result->date); ?>" class="form-control" required>
              </div>
            </div>
          </div>
        </div>
