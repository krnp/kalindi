                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-desktop"></i> Entries <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo e(url('accounts-heads')); ?>"> Account Heads</a></li>
                      <li><a href="<?php echo e(url('receipt')); ?>">Receipt Vouchers</a></li>
                      <li><a href="<?php echo e(url('payment')); ?>">Payment Vouchers</a></li>
                      <li><a href="<?php echo e(url('journal')); ?>">Journal Vouchers</a></li>
                      <li><a href="<?php echo e(url('bank_receipt')); ?>">Bank Receipt Vouchers</a></li>
                     <!--  <li><a href="widgets.html">Bank Payment Vouchers</a></li> -->
                      <li><a href="invoice.html">Cash Voucher</a></li>
                      <li><a href="<?php echo e(url('type-of-accounts')); ?>">Types of Account</a></li>
                    </ul>
                  </li>
