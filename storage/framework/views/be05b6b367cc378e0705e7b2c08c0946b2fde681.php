 ...
 <div class="row hidemsg" >
  ...
  <div class="x_panel">
    ...
    <div class="x_content"> <br>
      <form class="form-horizontal" method="POST" action="<?php echo e(url('bank_receipt/add')); ?>" enctype="multipart/form-data">
          ...
          <input type="text" name="v_no" value="" onkeyup="this.value=this.value.replace(/[^\d]/,'')"  class="form-control" maxlength="6" required>
            ...
            <div class="col-md-6">
              <div class="row">
                ...
                <div class="col-md-12">
                  <input type="text" name="bank_code" value="" class="form-control" maxlength="10" required="">
                </div>
              </div>
            </div>
          <div class="col-md-6">
       ...
       <div class="row">
          <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <input type="text" name="ch_no" class="form-control" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-12">
                <input name="date" id="ch_date" class="form-control" required>
              </div>
            </div>
          </div>
        </div>
