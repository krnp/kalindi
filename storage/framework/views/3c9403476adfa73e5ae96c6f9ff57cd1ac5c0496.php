...
<div class="col-md-12 col-sm-12 col-xs-12">
 ...
 <div class="row hidemsg" >
  ...
  <div class="x_panel">
    <div class="x_title">
      <h2>Field Excutive Application</h2>
    ...
    <div class="x_content"> <br>
      <form class="form-horizontal" method="POST" action="<?php echo e(url('fieldexcutive/edit',array($result->id))); ?>" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                   <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select Category" style="width: 100%;" tabindex="-1" aria-hidden="true" name="assign_area[]" required>
					  ...
					  <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($area->id); ?>" <?php if(in_array($area->id, explode(',',$result->assign_area))): ?> selected="selected" <?php endif; ?>> <?php echo e($area->area); ?> </option>
     ...
     <div class="row">
          <div class="col-md-6">
           ...
           <div class="row">
              ...
              <div class="col-md-12">
                <textarea name="address" class="form-control" required > <?php echo e($result->address); ?></textarea>
              </div>
            </div>
          </div>
          <div class="col-md-6">
              ...
              <div class="col-md-12">
                <input type="file" name="profile_pic" id="profile_pic">
                  ...
                  <?php if($result->profile_pic): ?>
                    <img src="<?php echo e(URL::asset('images/'.$result->profile_pic)); ?>" width="80" height="80" id="oldimg">
                 <?php endif; ?>
              </div>
            </div>
          </div>
